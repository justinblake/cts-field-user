...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_deploy_manager__ = __webpack_require__(507);
...
var HomePage = (function () {
    ...
    HomePage.prototype.updateTest = function () {
        var _this = this;
        Object(__WEBPACK_IMPORTED_MODULE_12__providers_deploy_manager__["b" /* update */])().then(function (res) {
            if (res === 'true') {
                _this.checkUpdates();
    ...
    HomePage.prototype.checkUpdates = function () {
        Object(__WEBPACK_IMPORTED_MODULE_12__providers_deploy_manager__["a" /* loadNewVersion */])();
    };
    return HomePage;
}());
__decorate([
...
/* harmony export (immutable) */ __webpack_exports__["a"] = loadNewVersion;
function update(callback) {
    ...
    IonicCordova.deploy.init(config, function (res) {
        console.log(res);
    }, function (err) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        IonicCordova.deploy.check(function (response) {
            ...
            if (response === 'true') {
                ...
                IonicCordova.deploy.download(function (result) {
                    if (result === 'true' || result == 'false') {
                        // We can unzip the latest version
                        IonicCordova.deploy.extract(config.appId, function (res) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_reject_notes_reject_notes__ = __webpack_require__(273);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__providers_storage_service__ = __webpack_require__(274);
